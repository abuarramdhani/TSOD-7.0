...
<?php if ($msg!=2) { ?>
input.username{background:#fff;}
<?php } else { ?>	
input.username{background:#FFB7B7;}
<?php } if ($msg!=3) { ?>
input.password{background:#fff;}
<?php } else { ?>	
input.password{background:#FFB7B7;}
<?php } ?></style>
...
<!--
var sprytextfield1 = new Spry.Widget.ValidationTextField("sprytextfield1", "custom", {pattern:"00-0000-0000-0", useCharacterMasking:true});
