<?php
	...
	if (!empty($_GET[id_ujian]))
		$_SESSION['id_ujian']=$_GET[id_ujian];		
		
	$namber=$converter->decode($_GET[namber]);
	
	$jmlsoal=mysql_num_rows(mysql_query("SELECT * FROM soal WHERE kd_modul='$_SESSION[id_ujian]' ORDER BY kd_soal"));	
	$_SESSION[jml_soal]=$jmlsoal;
	$d=mysql_fetch_row(mysql_query("SELECT * FROM modul WHERE kd_modul='$_SESSION[id_ujian]'"));	

    $_SESSION[nm_ujian]=$d[1];
	$_SESSION[panduan]="percobaan";
?>
<!DOCTYPE html>
...
<?php
	...
	{
		$ans=explode("_",$jwban);
		$dt=mysql_fetch_array(mysql_query("SELECT * FROM soal WHERE kd_soal='$ans[1]' ORDER BY kd_soal"));
		switch ($ans[3])
		{
			case 'A' : 	$jwb=$dt[a]; break;
			case 'B' : 	$jwb=$dt[alt_1]; break;
			case 'C' : 	$jwb=$dt[alt_2]; break;
			case 'D' : 	$jwb=$dt[alt_3]; break;
			case 'E' : 	$jwb=$dt[alt_4]; break;
		}
	}
	...
	$rec=mysql_fetch_array(mysql_query("SELECT * FROM soal WHERE  kd_modul='$_SESSION[id_ujian]' ORDER BY kd_soal LIMIT $nomorbaru,1"));
	$soalnya=$rec[kd_soal];
	$pil1nya=$rec[a];
	$pil2nya=$rec[alt_1];
	$pil3nya=$rec[alt_2];
...
<div data-bind="with: testDetailList">
	<section class="page-section timer-section" <?php if ($end==1) echo 'style="display: none"'; ?>>
    	<div class="row">
        	<div class="col-xs-9">
            	<h1 class="page-label soal-label">SOAL NO <span class="soal-no <?php if($rag=='ragu') echo "unsure"; ?>"><?php echo $nomor ?></span> <?php echo strtoupper("$_SESSION[nm_ujian]");?></h1><h4><?php echo "$_SESSION[panduan]";?></h4>
            </div>
...
<div style="width:100%; min-height: 50px;">  
	...
	<img id="optionA" name="<?php echo "p_".$kdsoal."_".$nomor."_A" ?>" alt="option a" style=" vertical-align:text-top; cursor:hand;" onClick="changeOnClick(this); MM_goToURL('parent','ujianview.php?namber=<?php echo $_GET['namber'] ?>&ids=<?php echo $converter->encode("p_".$kdsoal."_".$nomor."_A") ?>');return document.MM_returnValue"  src="./assets/<?php echo $pica ?>">
    </div>
    <div style="width:95%; vertical-align:middle; min-height: 50px; float:right;"><p>
...
<div style="width:100%; min-height: 50px;">  
    <div style=" width:5%; min-height: 50px; float:left;"> 
	<img id="optionB" name="<?php echo "p_".$kdsoal."_".$nomor."_B" ?>" alt="option b" style="vertical-align:middle; cursor:hand;" onClick="changeOnClick(this); MM_goToURL('parent','ujianview.php?namber=<?php echo $_GET['namber'] ?>&ids=<?php echo $converter->encode("p_".$kdsoal."_".$nomor."_B") ?>');return document.MM_returnValue" src="./assets/<?php echo $picb ?>"> 
    </div>
    <div style="width:95%; vertical-align:middle; min-height: 50px; float:right;"><p>
...
<div style="width:100%; min-height: 50px;">  
    <div style=" width:5%; min-height: 50px; float:left;"> 
    <img id="optionC" name="<?php echo "p_".$kdsoal."_".$nomor."_C" ?>" alt="option c" style="vertical-align:middle; cursor:hand;" onClick="changeOnClick(this); MM_goToURL('parent','ujianview.php?namber=<?php echo $_GET['namber'] ?>&ids=<?php echo $converter->encode("p_".$kdsoal."_".$nomor."_C") ?>');return document.MM_returnValue" src="./assets/<?php echo $picc ?>"> 
    </div>
    <div style="width:95%; vertical-align:middle; min-height: 50px; float:right;"><p>
...
<div style="width:100%; min-height: 50px;">  
    <div style=" width:5%; min-height: 50px; float:left;"> 
    <img id="optionD" name="<?php echo "p_".$kdsoal."_".$nomor."_D" ?>" alt="option d" style="vertical-align:middle; cursor:hand;" onClick="changeOnClick(this); MM_goToURL('parent','ujianview.php?namber=<?php echo $_GET['namber'] ?>&ids=<?php echo $converter->encode("p_".$kdsoal."_".$nomor."_D") ?>');return document.MM_returnValue" src="./assets/<?php echo $picd ?>"> 
    </div>
    <div style="width:95%; vertical-align:middle; min-height: 50px; float:right;"><p>
...
<div style="width:100%; min-height: 50px;">  
    <div style=" width:5%; min-height: 50px; float:left;"> 
    <img id="optionE" name="<?php echo "p_".$kdsoal."_".$nomor."_E" ?>" alt="option e" style="vertical-align:middle; cursor:hand;" onClick="changeOnClick(this); MM_goToURL('parent','ujianview.php?namber=<?php echo $_GET['namber'] ?>&ids=<?php echo $converter->encode("p_".$kdsoal."_".$nomor."_E") ?>');return document.MM_returnValue" src="./assets/<?php echo $pice ?>"> 
    </div>
    <div style="width:95%; vertical-align:middle; min-height: 50px; float:right;"><p>
...
<script>
	function slidein()
	{
		...
		setTimeout(function() {y.style="background-image:url(./assets/icon-arrow-left.png); background-repeat:no-repeat; background-position:7px 20px; font-size:1.1em; font-weight: 700;color: #fff; min-height: 40px; padding: 17px 0 0 28px;  width: 85px; left: -85px";},300);
		y.onclick = function(){ slide(); };
	}
	function slide()
	{
		...
		setTimeout(function() { y.style="background-image:url(./assets/icon-arrow-right.png); background-repeat:no-repeat; background-position:7px 20px; font-size:0em; font-weight: 700;color: #fff; min-height: 30px; padding: 17px 0 0 28px;  width: 30px; left: -30px";},300);
		y.onclick = function(){ slidein(); };
	}
</script>
   		<section class="page-section soal-navigation" <?php if ($end==1) echo 'style="display:none"'; ?>>
            <div class="action-wrapper">
                <div class="row">
                    <div class="col-xs-4">
                        <button class="btn btn-primary btn-prev activebutton" id="btnPrevSoal" onClick="MM_goToURL('parent','ujianview.php?namber=<?php echo $pref ?>');return document.MM_returnValue" <?php echo $dis1 ?>>SOAL SEBELUMNYA</button>
                    </div>
              <div class="col-xs-4 text-center" id="ragu_ragu" style="transition:0.5s">
                        <div class="unsure-checkbox" data-bind="with: testDetails()[currentNo()]">
                            <input name="<?php echo $kdsoal ?>" type="checkbox" id="unsureCheckbox" onClick="MM_goToURL('parent','ujianview.php?namber=<?php echo $_GET['namber'] ?>&id=<?php echo $converter->encode($soalnya) ?>&ragu=<?php if($rag=='ragu') echo $converter->encode('tdkragu'); else echo $converter->encode('ragu') ?>'); return document.MM_returnValue" <?php if($rag=='ragu') echo "checked";  ?> >
                            <label class="labelUnsureCheckbox" for="unsureCheckbox"> RAGU - RAGU</label>
                        </div>
                    </div>
              <div class="col-xs-4 text-right">
                        <button id="btnNextSoal"  onClick="MM_goToURL('parent','ujianview.php?namber=<?php echo $next ?>');return document.MM_returnValue"  class="btn btn-primary btn-next activebutton" <?php echo $dis2 ?> style="transition:0.5s">SOAL BERIKUTNYA</button>
...
<div class="panel-slide-content">
              <ul>
<?php
$qry=mysql_query("SELECT * FROM soal WHERE kd_modul='$_SESSION[id_ujian]' ORDER BY kd_soal");
...
?>
                    <li class="<?php echo "$sdh" ?>"><a href="ujianview.php?namber=<?php echo $converter->encode($no); ?>"><?php echo $no ?></a><span><?php echo $dt[opt] ?></span></li>
<?php } ?>
              </ul>
<?php if ($shddijerjakan>=($jmlsoal*(3/4))) { ?>              
          <button type="submit" class="btn btn-danger btn-block" onClick="MM_goToURL('parent','ujianview.php?namber=<?php echo $_GET['namber'] ?>&end=<?php echo $converter->encode('1'); ?>');return document.MM_returnValue">Selesai</button> <?php } ?>
          </div>
        </div>            <!--tombol selesai-->
<style>
.page-column {
            ...
            <div id="dialogKonfirmasi">
                <div class="panel panel-default">
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-xs-6">
                                <button type="submit" disabled class="btn btn-success btn-block" id="btnLanjut1" onClick="" data-bind="click: redirectToDone">SELESAI</button>
                            </div>
                      <div class="col-xs-6">
                                <button onClick="" type="submit" class="btn btn-danger btn-block">TIDAK</button>
                            </div>
                      </div>
                    </div>
            </div>
            ...
            <div id="dialogStillTimeKonfirmasi">
                <div class="panel panel-default">
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-xs-6">
                                <button id="btnLanjut2" type="submit" class="btn btn-success btn-block" disabled>SELESAI</button>
                            </div>
                      <div class="col-xs-6">
            ...
            <div id="dialogRaguKonfirmasi">
                <div class="panel panel-default">
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-xs-12">
                              <button  onClick="MM_goToURL('parent','ujianview.php?namber=<?php echo $_GET['namber'] ?>');return document.MM_returnValue" type="submit" class="btn btn-danger btn-block">YA</button>
                            </div>
                      </div>
                    </div>
                </div>
...
function doc_keyUp(e) {    
    if (e.keyCode == 190)  {
        MM_goToURL('parent','ujianview.php?namber=<?php echo $next ?>');
        return document.MM_returnValue;    
    }
    else if (e.keyCode == 188)  {
        MM_goToURL('parent','ujianview.php?namber=<?php echo $pref ?>');
        return document.MM_returnValue;    
    }
